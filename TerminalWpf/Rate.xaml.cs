    ...
    public partial class Rate : Window
    {
        ...
        private void Slider_ValueChanged(object sender, RoutedPropertyChangedEventArgs<double> e)
        {
            ...
            if (slider == 1)
            {
                ...
                Slider.Foreground = new SolidColorBrush(Color.FromArgb(255, 195, 255, 0));
            }
            if (slider == 2)
            {
                ...
                Slider.Foreground = new SolidColorBrush(Color.FromArgb(255, 145, 255, 0));
            }
            if (slider == 3)
            {
                img1.Visibility = Visibility.Hidden;
                ...
                Slider.Foreground = new SolidColorBrush(Color.FromArgb(255, 95, 255, 0));
            }
            if (slider == 4)
            {
                img1.Visibility = Visibility.Hidden;
                ...
                Slider.Foreground = new SolidColorBrush(Color.FromArgb(255, 45, 255, 0));
            }
            if (slider == 5)
            {
                img1.Visibility = Visibility.Hidden;
                ...
                Slider.Foreground = new SolidColorBrush(Color.FromArgb(255, 0, 255, 0));
            }
